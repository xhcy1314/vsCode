...
function initialize(context) {
    ...
    projectAutoDetection_1.ProjectAutoDetection
        .detectProject(vscode_extensions_1.findFiles, config)
...
function detectAngular(config, results) {
    ...
    const presetValue = vscode_extensions_1.getConfig().inspect(`vsicons.presets.angular`)
        .workspaceValue;
